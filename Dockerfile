...
#   - ruff: pure-Rust linter + formatter (no crates.io publish, must come via uv)
#   - mypy: type-checker for tools/*.py
#   - img2pdf: turns the cleaned PBM directories into proof-PDFs the
#     human can scrub in any viewer (`just to-pdf`)
